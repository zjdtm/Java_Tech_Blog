    ...
    private MemberSecurityDTO generatedDTO(String email, Map<String, Object> params){
        ...
        if(result.isEmpty()){
            ...
            MemberSecurityDTO memberSecurityDTO =
                    new MemberSecurityDTO(member.getMid(), member.getMpw(), member.getEmail(), member.isDel(),
                            member.isSocial(), member.getRoleSet().stream().map(memberRole -> new SimpleGrantedAuthority(
